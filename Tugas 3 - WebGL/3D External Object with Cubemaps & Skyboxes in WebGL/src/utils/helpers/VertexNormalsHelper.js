...
import * as glMatrix from "../../engine/index.js";
...
function VertexNormalHelper(gl,shaderProgram_Normal,model,PROJMATRIX,VIEWMATRIX,MODELMATRIX,NORMALMATRIX) {

   //--- Normal ------------------------------------------------------------------------

    let ModelVertices   =  model.vertices;
    let ModelNormal     =  model.normals;
 ...
 export {loadNormalShaders,VertexNormalHelper}